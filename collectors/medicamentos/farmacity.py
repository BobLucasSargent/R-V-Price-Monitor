"""
Farmacity collector — VTEX Search API (API-based, no Playwright)
================================================================
...
Covers COICOP:
- 06.1.1 Medicamentos OTC (analgesics, digestives, cold/flu)
- 12.1.3 Cuidado personal (creams, shampoo, deodorant, toothbrushes)
"""
...
# (category_path, division_coicop, coicop_category, n_items)
CATEGORIES = [
...
class FarmacityCollector(BaseCollector):
    ...
    def _parse(
        ...
        """Parse one VTEX product JSON into a PriceObservation."""
        try:
